                            ...
                            <tr key={index} className="border-t border-borderColor">
                                <td className="p-3 flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-500 font-medium text-sm">{car.seating_capacity} seats - {car.transmission}</p>
                                    </div>
                                </td>
                                ...
                                <td className="p-3 max-md:hidden">
                                    <span className={`px-3 py-1 rounded-full text-sm ${car.isAvaliable ?
                                         'bg-green-100 text-green-500' : 'bg-red-100 text-red-500'}`}>
                                        {car.isAvaliable ? "Available" : "Unavailable"}
                                    </span>
                                </td>

                                <td className="flex text-center p-3">
